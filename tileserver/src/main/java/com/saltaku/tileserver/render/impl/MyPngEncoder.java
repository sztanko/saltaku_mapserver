...
public class MyPngEncoder extends Object {
     ...
     * @see java.awt.Image
     */
    public MyPngEncoder(int[] image, boolean encodeAlpha) {
     ...
     * @see java.awt.Image
     */
    public MyPngEncoder(int[] image, boolean encodeAlpha, int whichFilter) {
     ...
     * @see java.awt.Image
     */
    public MyPngEncoder(int[] image, boolean encodeAlpha, int whichFilter, int compLevel) {
        this.image = image;
    ...
    public byte[] pngEncode(boolean encodeAlpha) {
        ...
        width = 256;//image.getWidth(null);
        height = 256;//image.getHeight(null);
    ...
    protected boolean writeImageData() {
        ...
        try {
            while (rowsLeft > 0) {
                ...
                int[] pixels = image;//new int[width * nRows];
